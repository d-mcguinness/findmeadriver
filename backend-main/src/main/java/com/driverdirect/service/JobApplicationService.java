...
public interface JobApplicationService {
    ...
    enum Eligibility { OK, JOB_NOT_OPEN, ALREADY_APPLIED, MODE_UNSUPPORTED, LICENCE, AVAILABILITY, CABOTAGE }
    ...
    List<JobApplicationResponse> getApplicationsForJob(Long jobId, Shipper shipper);

    JobApplicationResponse acceptApplication(Long applicationId, Shipper shipper);

    JobApplicationResponse rejectApplication(Long applicationId, Shipper shipper);
