...
- `ServiceEdge` (interface) + `ScheduledServiceEdge` (rail/sea/air, will attach to `CarrierLane` once it grows timetable columns) + `RoadEdge` (virtual — generated on demand within a radius, never stored).
